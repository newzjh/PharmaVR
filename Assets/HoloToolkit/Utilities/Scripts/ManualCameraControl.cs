...
public class ManualCameraControl : MonoBehaviour
{
    ...
    private bool isFlyKeypressEnabled = false;
    ...
    private void Update()
    {
        if (Application.platform == RuntimePlatform.WSAPlayerX64 ||
            ...
            Application.platform == RuntimePlatform.WSAPlayerARM) return;
    ...
    private Vector3 GetCameraControlTranslation()
    {
        ...
        else
        {
            ...
            deltaPosition += GetKeyDir("end", "home") * Vector3.up;
        }
    ...
    private Vector3 GetCameraControlRotation()
    {
        ...
        {
            float deltavalue = Time.deltaTime*8.0f;
    ...
    private void OnGUI()
    {
        ...
        if (GUI.Button(new Rect(sw-360, sh - 130, 50, 50), "left"))
        {
            this.transform.position -= this.transform.right*0.7f;
        }
        else if (GUI.Button(new Rect(sw-300, sh - 130, 50, 50), "right"))
        {
            this.transform.position += this.transform.right*0.7f;
        }
        else if (GUI.Button(new Rect(sw-240, sh - 130, 50, 50), "back"))
        {
            this.transform.position -= this.transform.forward*0.7f;
        }
        else if (GUI.Button(new Rect(sw-180, sh - 130, 50, 50), "forward"))
        {
            this.transform.position += this.transform.forward*0.7f;
        }
        else if (GUI.Button(new Rect(sw-120, sh - 130, 50, 50), "down"))
        {
            this.transform.position -= this.transform.up * 0.7f;
        }
        else if (GUI.Button(new Rect(sw-60, sh - 130, 50, 50), "up"))
        {
            this.transform.position += this.transform.up * 0.7f;
        }

        if (GUI.Button(new Rect(sw-240, sh - 70, 50, 50), "<"))
        {
            Vector3 angle = this.transform.eulerAngles;
            angle.y -= 10.0f;
            this.transform.eulerAngles = angle;
        }
        else if (GUI.Button(new Rect(sw-180, sh - 70, 50, 50), ">"))
        {
            Vector3 angle = this.transform.eulerAngles;
            angle.y += 10.0f;
            this.transform.eulerAngles = angle;
        }
        else if (GUI.Button(new Rect(sw-120, sh - 70, 50, 50), "↑"))
        {
            Vector3 angle = this.transform.eulerAngles;
            angle.x -= 10.0f;
            this.transform.eulerAngles = angle;
        }
        else if (GUI.Button(new Rect(sw-60, sh - 70, 50, 50), "↓"))
        {
            Vector3 angle = this.transform.eulerAngles;
            angle.x += 10.0f;
            this.transform.eulerAngles = angle;
