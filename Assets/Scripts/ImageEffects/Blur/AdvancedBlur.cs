...
namespace ImageEffects
{
    public class AdvancedBlur : IBlur
    {
        ...
        public AdvancedBlur()
        {
            Shader shader = Shader.Find("ImageEffect/Glow/Compose");
            Shader shader2 = Shader.Find("ImageEffect/Glow/Advanced Blur");
            Shader shader3 = Shader.Find("ImageEffect/Glow/Downsample");
