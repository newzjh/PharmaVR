...
namespace ImageEffects
{
    public abstract class BlurBase
    {
        ...
        public BlurBase()
        {
            Shader compaseShader = Shader.Find("ImageEffect/Glow/Compose");
            Shader blurShader = Shader.Find("ImageEffect/Glow/Blur GL");
            if (!blurShader.isSupported)
            {
                glMode = false;
                blurShader = Shader.Find("ImageEffect/Glow/Blur");
            }
            Shader downSampleShader = Shader.Find("ImageEffect/Glow/Downsample");
