...
Shader "Effect/Glow/Transparent/Cutout/Soft Edge Unlit" {
Properties {
...
SubShader {
	Tags { "Queue"="AlphaTest" "IgnoreProjector"="True" "RenderType"="GlowTransparentCutout" "RenderEffect"="GlowTransparentCutout" }
	Lighting off
...
SubShader {
	Tags { "IgnoreProjector"="True" "RenderType"="GlowTransparentCutout" "RenderEffect"="GlowTransparentCutout" }
	Lighting off
