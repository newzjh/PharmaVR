...
Shader "Effect/Glow/GlowDissloveOpaqueObjects" {
 ...
 Subshader {
    Tags { "RenderType"="Opaque" "Queue"="Geometry" "DissolveGolw"="OpaqueDissolveGolw"}
    Pass {    
        Cull Off Lighting Off ZWrite On ZTest LEqual Fog { Mode off } 
